...
%  			\draw[red] (-3,3) rectangle (9,-4);
    ...
    % main modules
		  \node[rectangle,draw=black,minimum height=1.5cm,minimum width=2.5cm,above right] at (0,2) {Alarm active};
	    \node[rectangle,draw=black,minimum height=1.5cm,minimum width=2.5cm,above right] at (0,-2) {Alarm time};
	    \node[rectangle,draw=black,minimum height=1.5cm,minimum width=2.5cm,above right] at (5.25,0) {AlarmOn FSM};
		  % compare
		  \draw (3,0) -- (3.5, -.5) -- (3,-1) -- cycle;
      % OR
	    \node[rectangle,draw=black,minimum height=1cm,minimum width=1cm,above right] at (4,0.25) {OR};
...
%};
      ...
      % basic connections
		  \draw[->] (2.5,2.75)  -- (3.5,2.75)    -- (3.5,1)     -> (4,1);
		  \draw[->] (2.5,-0.75) -> (3,-0.75);
      \draw[->] (3.5, -0.5)    -- (3.75,-0.5)    -- (3.75, 0.5) -> (4,0.5);
      \draw[->] (5, 0.75) -> (5.25, 0.75);

      % input
      \node[above left] at (-.5,0){current\_time};
	    \draw[red!50!black,line width=2pt,->] (-1, 0)      -- (2.75,0)     -- (2.75, -0.25) -> (3,-0.25);
      \node[above left] at (-.5,-1){kc\_minus\_imp};
      \draw[red!50!black,line width=2pt,->] (-1,-1) -- (0,-1);
      \node[above left] at (-.5,-1.5){kc\_plus\_imp};
      \draw[red!50!black,line width=2pt,->] (-1,-1.5) -- (0,-1.5);
      \node[above left] at (-.5, -2){reset};
 		  \draw[red!50!black,line width=2pt,->] (-1,-2) -- (0,-2);
